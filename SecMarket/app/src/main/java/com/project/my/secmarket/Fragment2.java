...
import com.project.my.secmarket.market.Fragment1_adapter;
import com.project.my.secmarket.market.market_info_obj;
...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView= (RecyclerView)view.findViewById(R.id.fragment2_pager);
    ...
    public void initdata() {
        ...
        for (int i = 0; i < 10; i++) {
            market_obj.add(new market_info_obj("清晨lulululu"+i, "7:2"+i, "咖啡了开始放假卡罗拉是否考虑萨菲隆"+i,
