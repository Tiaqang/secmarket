...
//                        }).show();
    ...
    void post(String url,String name,String text,List<LocalImageHelper.LocalFile> list,String price,String tel)
        throws IOException{

        MultipartBody.Builder builder=new MultipartBody.Builder().setType(MultipartBody.FORM);
        for(int x=0;x<list.size();x++){
            File file=new File(list.get(x).getOriginalUri());
        ...
        builder.addFormDataPart("telnumner",tel);
